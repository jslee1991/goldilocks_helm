 ...
 *        $Id: row.c 33242 2021-03-15 08:58:42Z lkh $
 *
 * NOTES
 *
 *
                     ...
                     Py_ssize_t   aIndex )
{
    ...
    TRY_THROW( sRow->mColumnValues != NULL, RAMP_ERR_CLOSED );
    Py_INCREF( sRow->mColumnValues[sIdx] );

    return sRow->mColumnValues[sIdx];
                         ...
                         PyObject   * aValue )
{
    ...
    Py_XDECREF( sRow->mColumnValues[sIdx] );
    Py_INCREF( aValue );

    sRow->mColumnValues[sIdx] = aValue;
