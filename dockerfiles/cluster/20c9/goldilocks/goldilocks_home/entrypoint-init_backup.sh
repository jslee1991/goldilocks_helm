...
cat > /home/sunje/goldilocks_data/tmp/$MEMBER_NAME <<EOF
$MY_POD_IP
EOF
...
MASTER_DNS=`cat /home/sunje/goldilocks_data/tmp/$MASTER_OG`
...
echo "-------------------------start slave-------------------"
    MASTER_DNS=`cat /home/sunje/goldilocks_data/tmp/$MASTER`
