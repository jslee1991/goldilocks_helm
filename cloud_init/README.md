...
- DATA REBALANCE
- LOCATOR 정보 추가
- MEMBER나 GROUP추가 시 GLOBAL CONNECTION  위한 RECONNECTION 구문
```
...
- NFS로 MASTER IP를 기록하여 받아오는 방법? (얻는거 대비 비용이 ..)
- 아니면 SUNJE에서 REST API를 제공하여 G1N1 설치시 PUT하고 나머지 MEMBER에서 GET을? (간단하긴한데.. 이용자가 많아지면?)
``` 
