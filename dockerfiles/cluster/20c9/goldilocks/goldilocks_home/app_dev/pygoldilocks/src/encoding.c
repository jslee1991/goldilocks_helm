 ...
 *        $Id: encoding.c 26607 2018-12-20 09:45:10Z lkh $
 *
 * NOTES
 *
 *
...
int LookupEncode( const char * aEncoding )
{
    ...
    else if( strstr( "|utf-16|utf16|", sLower ) != NULL )
    {
        return ENC_UTF16;
    }
    else if( strstr( "|utf-16-le|utf-16le|utf16le|", sLower ) != NULL )
    {
        return ENC_UTF16LE;
    }
    else if( strstr( "|utf-16-be|utf-16be|utf16be|", sLower ) != NULL )
    {
        return ENC_UTF16BE;
    }
    else if( strstr( "|utf-32|utf32|", sLower ) != NULL )
    {
        return ENC_UTF32;
    }
    else if( strstr( "|utf-32-le|utf-32le|utf32le|", sLower ) != NULL )
    {
        return ENC_UTF32LE;
    }
    else if( strstr( "|utf-32-be|utf-32be|utf32be|", sLower ) != NULL )
    {
        return ENC_UTF32BE;
    }
    else if( strstr( "|latin-1|latin1|iso-8859-1|iso8859-1|", sLower ) != NULL )
    {
        return ENC_LATIN1;
    }
    else if( strstr( "|raw|ascii|", sLower ) != NULL )
    {
        return ENC_RAW;
    }
