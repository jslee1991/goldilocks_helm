...
/* Droptable funtion */
SQLRETURN testDroptable( SQLHDBC aDbc )
{
    SQLHSTMT     sStmt     = NULL;
    SQLINTEGER   sState    = 0;
    SQLRETURN    sReturn;
...
int main( int aArgc, char** aArgv )
{
    ...
    /* If you SQL_SUCCESS that is Droptable funtion success */ 
    GOLDILOCKS_SQL_TRY( testDroptable( sDbc ) );
