...
SELECT 
     ...
     , MODIFIED_TIME
     , COMMENTS
  FROM DEFINITION_SCHEMA.TABLES@GLOBAL[RANDOM_MEMBER]
 WHERE TABLE_TYPE <> 'SEQUENCE'
   AND IS_DROPPED = FALSE
 UNION ALL
SELECT 
       ( SELECT OWNER_ID FROM DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER] WHERE SCHEMA_NAME = 'FIXED_TABLE_SCHEMA' ) -- OWNER_ID
     , ( SELECT SCHEMA_ID FROM DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER] WHERE SCHEMA_NAME = 'FIXED_TABLE_SCHEMA' ) -- SCHEMA_ID
     , TABLE_ID
     , NULL -- TABLESPACE_ID
     , TABLE_NAME
     ...
     , NULL -- MODIFIED_TIME
     , COMMENTS
  FROM FIXED_TABLE_SCHEMA.X$TABLES@GLOBAL[RANDOM_MEMBER];
...
SELECT 
     ...
     , IS_UNUSED      
     , COMMENTS        
  FROM DEFINITION_SCHEMA.COLUMNS@GLOBAL[RANDOM_MEMBER]
 UNION ALL
SELECT 
       ( SELECT OWNER_ID FROM DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER] WHERE SCHEMA_NAME = 'FIXED_TABLE_SCHEMA' ) -- OWNER_ID
     , ( SELECT SCHEMA_ID FROM DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER] WHERE SCHEMA_NAME = 'FIXED_TABLE_SCHEMA' ) -- SCHEMA_ID
     ...
     , FALSE -- IS_UNUSED                           
     , COMMENTS        
  FROM FIXED_TABLE_SCHEMA.X$COLUMNS@GLOBAL[RANDOM_MEMBER]
;
...
SELECT
     ...
     , ATTR_TYPE_VARIABLE_NAME
     , ATTR_TYPE_FIELD_NAME
  FROM DEFINITION_SCHEMA.DATA_TYPE_DESCRIPTOR@GLOBAL[RANDOM_MEMBER]
 UNION ALL
SELECT
       ( SELECT OWNER_ID FROM DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER] WHERE SCHEMA_NAME = 'FIXED_TABLE_SCHEMA' )  -- OBJECT_OWNER_ID
     , ( SELECT SCHEMA_ID FROM DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER] WHERE SCHEMA_NAME = 'FIXED_TABLE_SCHEMA' ) -- OBJECT_SCHEMA_ID
     , TABLE_ID  -- OBJECT_ID
     , 'TABLE'
     , COLUMN_ID -- DTD_IDENTIFIER
     , DATA_TYPE 
...
--##############################################################
--# INFORMATION_SCHEMA.WHOLE_TAB_PHYSICAL
--# internal use only
--##############################################################
...
DROP VIEW IF EXISTS INFORMATION_SCHEMA.WHOLE_TAB_PHYSICAL;

--#####################
--# create view
--#####################

CREATE VIEW INFORMATION_SCHEMA.WHOLE_TAB_PHYSICAL
(
       SCHEMA_NAME
     , TABLE_NAME
     , PCTFREE
...
SELECT
     ...
     , MAX( xtcac.INITRANS )
     , MAX( xtcac.MAXTRANS )
     , MAX( xseg.INITIAL_EXTENTS )
     , MAX( xseg.NEXT_EXTENTS )
     , MAX( xseg.MIN_EXTENTS )
     , MAX( xseg.MAX_EXTENTS )
     , MAX( xtcac.LOGGING )
     , SUM( xseg.ALLOC_PAGE_COUNT )
  FROM
...
COMMENT ON TABLE INFORMATION_SCHEMA.WHOLE_TAB_PHYSICAL
        IS 'internal use only';
...
GRANT SELECT ON TABLE INFORMATION_SCHEMA.WHOLE_TAB_PHYSICAL TO PUBLIC;

COMMIT;


--##############################################################
--# INFORMATION_SCHEMA.WHOLE_IDX_PHYSICAL
--# internal use only
--##############################################################
...
DROP VIEW IF EXISTS INFORMATION_SCHEMA.WHOLE_IDX_PHYSICAL;

--#####################
--# create view
--#####################

CREATE VIEW INFORMATION_SCHEMA.WHOLE_IDX_PHYSICAL
(
       TABLE_SCHEMA
     , TABLE_NAME
     , INDEX_SCHEMA
...
SELECT
       /*+
           ORDERED
           USE_HASH( idx, xidx, xseg, sch1, tab, sch2 )
        */
       sch1.SCHEMA_NAME
     , tab.TABLE_NAME
     , sch2.SCHEMA_NAME
  ...
  FROM
     ...
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[IGNORE_INACTIVE_MEMBER]         AS sch1
     , DEFINITION_SCHEMA.TABLES@GLOBAL[IGNORE_INACTIVE_MEMBER]           AS tab
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[IGNORE_INACTIVE_MEMBER]         AS sch2
 WHERE
       sch1.SCHEMA_ID         = tab.SCHEMA_ID
   AND sch1.CLUSTER_MEMBER_ID = tab.CLUSTER_MEMBER_ID
   AND tab.TABLE_ID           = idx.TABLE_ID
   AND tab.CLUSTER_MEMBER_ID  = idx.CLUSTER_MEMBER_ID
   AND idx.SCHEMA_ID          = sch2.SCHEMA_ID
   AND idx.CLUSTER_MEMBER_ID  = sch2.CLUSTER_MEMBER_ID
...
COMMENT ON TABLE INFORMATION_SCHEMA.WHOLE_IDX_PHYSICAL
        IS 'internal use only';
...
GRANT SELECT ON TABLE INFORMATION_SCHEMA.WHOLE_IDX_PHYSICAL TO PUBLIC;
...
SELECT 
     ...
     , CAST( NULL AS VARCHAR(128 OCTETS) ) -- dtd.COLLATION_OWNER_CATALOG
     , CAST( NULL AS VARCHAR(128 OCTETS) ) -- dtd.COLLATION_SCHEMA_NAME 
 ...
 WHERE  
   ...
   AND ( col.COLUMN_ID IN ( SELECT pvcol.COLUMN_ID 
                              FROM DEFINITION_SCHEMA.COLUMN_PRIVILEGES@GLOBAL[RANDOM_MEMBER] AS pvcol 
                             WHERE ( pvcol.GRANTEE_ID IN ( SELECT AUTH_ID 
                                                             FROM DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER] AS aucol 
         ...
         tab.TABLE_ID IN ( SELECT pvtab.TABLE_ID 
                             FROM DEFINITION_SCHEMA.TABLE_PRIVILEGES@GLOBAL[RANDOM_MEMBER] AS pvtab 
                            WHERE ( pvtab.GRANTEE_ID IN ( SELECT AUTH_ID 
                                                            FROM DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER] AS autab 
         ...
         sch.SCHEMA_ID IN ( SELECT pvsch.SCHEMA_ID 
                              FROM DEFINITION_SCHEMA.SCHEMA_PRIVILEGES@GLOBAL[RANDOM_MEMBER] AS pvsch 
                             WHERE pvsch.PRIVILEGE_TYPE IN ( 'CONTROL SCHEMA', 'SELECT TABLE', 'INSERT TABLE', 'DELETE TABLE', 'UPDATE TABLE', 'LOCK TABLE' ) 
                               AND ( pvsch.GRANTEE_ID IN ( SELECT AUTH_ID 
                                                             FROM DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER] AS ausch 
         ...
         EXISTS ( SELECT GRANTEE_ID  
                    FROM DEFINITION_SCHEMA.DATABASE_PRIVILEGES@GLOBAL[RANDOM_MEMBER] pvdba 
                   WHERE pvdba.PRIVILEGE_TYPE IN ( 'SELECT ANY TABLE', 'INSERT ANY TABLE', 'DELETE ANY TABLE', 'UPDATE ANY TABLE', 'LOCK ANY TABLE' ) 
                     AND ( pvdba.GRANTEE_ID IN ( SELECT AUTH_ID 
                                                   FROM DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER] AS audba 
...
SELECT
     ...
     , pvcol.IS_GRANTABLE
  FROM
       DEFINITION_SCHEMA.COLUMN_PRIVILEGES@GLOBAL[RANDOM_MEMBER] AS pvcol 
     , DEFINITION_SCHEMA.COLUMNS@GLOBAL[RANDOM_MEMBER]           AS col 
     , DEFINITION_SCHEMA.TABLES@GLOBAL[RANDOM_MEMBER]            AS tab 
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]          AS sch 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]    AS grantor
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]    AS grantee
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]    AS owner
 WHERE
  ...
  FROM
       ( ( 
           SELECT 
                ...
                , TABLE_ID
                , COLUMN_ID
             FROM DEFINITION_SCHEMA.CHECK_COLUMN_USAGE@GLOBAL[RANDOM_MEMBER] ccu 
         )
         UNION ALL
         (
           SELECT
                ...
                , kcu.TABLE_ID
                , kcu.COLUMN_ID
             FROM DEFINITION_SCHEMA.REFERENTIAL_CONSTRAINTS@GLOBAL[RANDOM_MEMBER] AS rfc
                , DEFINITION_SCHEMA.KEY_COLUMN_USAGE@GLOBAL[RANDOM_MEMBER]        AS kcu 
            WHERE
         ...
         (
           SELECT
                ...
                , kcu.TABLE_ID
                , kcu.COLUMN_ID
             FROM DEFINITION_SCHEMA.TABLE_CONSTRAINTS@GLOBAL[RANDOM_MEMBER]       AS tcn
                , DEFINITION_SCHEMA.KEY_COLUMN_USAGE@GLOBAL[RANDOM_MEMBER]        AS kcu 
            WHERE
     ...
     , DEFINITION_SCHEMA.COLUMNS@GLOBAL[RANDOM_MEMBER]            AS col
     , DEFINITION_SCHEMA.TABLES@GLOBAL[RANDOM_MEMBER]             AS tab
     , DEFINITION_SCHEMA.TABLE_CONSTRAINTS@GLOBAL[RANDOM_MEMBER]  AS tcon
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]           AS sch1
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]           AS sch2
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]     AS auth1
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]     AS auth2
 WHERE
  ...
  FROM
       ( ( 
           SELECT 
                ...
                , TABLE_SCHEMA_ID
                , TABLE_ID
             FROM DEFINITION_SCHEMA.CHECK_TABLE_USAGE@GLOBAL[RANDOM_MEMBER] ctu 
         )
         UNION ALL
         (
           SELECT
                ...
                , tcn.TABLE_ID
             FROM DEFINITION_SCHEMA.REFERENTIAL_CONSTRAINTS@GLOBAL[RANDOM_MEMBER] AS rfc
                , DEFINITION_SCHEMA.TABLE_CONSTRAINTS@GLOBAL[RANDOM_MEMBER]       AS tcn
            WHERE
 ...
 WHERE
   ...
   AND ( 
         ( SELECT MAX( kcu2.ORDINAL_POSITION )
             FROM DEFINITION_SCHEMA.KEY_COLUMN_USAGE@GLOBAL[RANDOM_MEMBER]   AS kcu2
            WHERE kcu2.CONSTRAINT_ID = kcu.CONSTRAINT_ID )
         =
         ( SELECT COUNT(*)
             FROM DEFINITION_SCHEMA.KEY_COLUMN_USAGE@GLOBAL[RANDOM_MEMBER]   AS kcu3
...
SELECT 
  ...
  FROM 
       DEFINITION_SCHEMA.REFERENTIAL_CONSTRAINTS@GLOBAL[RANDOM_MEMBER]  AS rcon
     , DEFINITION_SCHEMA.TABLE_CONSTRAINTS@GLOBAL[RANDOM_MEMBER]        AS tcon
     , DEFINITION_SCHEMA.KEY_COLUMN_USAGE@GLOBAL[RANDOM_MEMBER]         AS rkcu
     , DEFINITION_SCHEMA.TABLE_CONSTRAINTS@GLOBAL[RANDOM_MEMBER]        AS ucon
     , DEFINITION_SCHEMA.KEY_COLUMN_USAGE@GLOBAL[RANDOM_MEMBER]         AS ukcu
     , DEFINITION_SCHEMA.COLUMNS@GLOBAL[RANDOM_MEMBER]                  AS rcol
     , DEFINITION_SCHEMA.COLUMNS@GLOBAL[RANDOM_MEMBER]                  AS ucol
     , DEFINITION_SCHEMA.TABLES@GLOBAL[RANDOM_MEMBER]                   AS rtab
     , DEFINITION_SCHEMA.TABLES@GLOBAL[RANDOM_MEMBER]                   AS utab
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]                 AS sch1 
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]                 AS sch2 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]           AS auth1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]           AS auth2 
 ...
 WHERE 
   ...
   AND ( auth.AUTHORIZATION_NAME = CURRENT_USER
         ...
         sch.SCHEMA_ID IN ( SELECT pvusg.SCHEMA_ID 
                             FROM DEFINITION_SCHEMA.USAGE_PRIVILEGES@GLOBAL[RANDOM_MEMBER] AS pvusg
                            WHERE ( pvusg.GRANTEE_ID IN ( SELECT AUTH_ID 
                                                            FROM DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER] AS auusg 
...
SELECT 
     ...
     , sqc.COMMENTS
  FROM 
       DEFINITION_SCHEMA.SEQUENCES@GLOBAL[RANDOM_MEMBER]       AS sqc
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]        AS sch
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]  AS auth
 WHERE 
...
SELECT
     ...
     , COMMENTS
  FROM 
       DEFINITION_SCHEMA.SQL_CONFORMANCE@GLOBAL[RANDOM_MEMBER]
 WHERE
...
SELECT
     ...
     , COMMENTS
  FROM 
       DEFINITION_SCHEMA.SQL_IMPLEMENTATION_INFO@GLOBAL[RANDOM_MEMBER]
 ORDER BY
       IMPLEMENTATION_INFO_ID
;
...
SELECT
     ...
     , COMMENTS
  FROM 
       DEFINITION_SCHEMA.SQL_SIZING@GLOBAL[RANDOM_MEMBER]
 ORDER BY
       SIZING_ID
;
...
SELECT
     ...
     , CAST( iphy.ALLOC_PAGE_COUNT AS NUMBER )         -- PAGES
     , CAST( NULL AS VARCHAR(1024 OCTETS) )            -- FILTER_CONDITION
     , idx.COMMENTS                                    -- COMMENTS 
  FROM
       DEFINITION_SCHEMA.INDEX_KEY_COLUMN_USAGE@GLOBAL[RANDOM_MEMBER] AS ikey
     , DEFINITION_SCHEMA.INDEXES@GLOBAL[RANDOM_MEMBER]                AS idx
       LEFT OUTER JOIN
       DEFINITION_SCHEMA.STAT_INDEX@GLOBAL[RANDOM_MEMBER]             AS stat
     ...
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]               AS sch2 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]         AS auth2 
     , INFORMATION_SCHEMA.WHOLE_IDX_PHYSICAL                          AS iphy
 WHERE
   ...
   AND sch1.SCHEMA_NAME       = iphy.INDEX_SCHEMA
   AND idx.INDEX_NAME         = iphy.INDEX_NAME
   AND sch2.SCHEMA_NAME       = iphy.TABLE_SCHEMA
...
SELECT  
     ...
     , CAST( tphy.ALLOC_PAGE_COUNT AS NUMBER )         -- PAGES
     , CAST( NULL AS VARCHAR(1024 OCTETS) )            -- FILTER_CONDITION
     , tab.COMMENTS                                    -- COMMENTS 
  FROM  
       DEFINITION_SCHEMA.TABLES@GLOBAL[RANDOM_MEMBER]           AS tab 
       LEFT OUTER JOIN
       DEFINITION_SCHEMA.STAT_TABLE@GLOBAL[RANDOM_MEMBER]       AS stat 
       ON tab.TABLE_ID = stat.TABLE_ID
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]         AS sch 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]   AS auth 
     , INFORMATION_SCHEMA.WHOLE_TAB_PHYSICAL                    AS tphy
 WHERE 
...
SELECT  
  ...
  FROM  
       ( INFORMATION_SCHEMA.WHOLE_TABLES       AS tab 
         LEFT OUTER JOIN 
         DEFINITION_SCHEMA.TABLESPACES@GLOBAL[RANDOM_MEMBER]   AS spc  
...
SELECT 
     ...
     , const.COMMENTS
  FROM 
       DEFINITION_SCHEMA.TABLE_CONSTRAINTS@GLOBAL[RANDOM_MEMBER]  AS const
     , DEFINITION_SCHEMA.TABLES@GLOBAL[RANDOM_MEMBER]             AS tab 
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]           AS sch1 
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]           AS sch2 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]     AS auth1 
...
SELECT
  ...
  FROM
       DEFINITION_SCHEMA.TABLE_PRIVILEGES@GLOBAL[RANDOM_MEMBER]  AS pvtab
     , DEFINITION_SCHEMA.TABLES@GLOBAL[RANDOM_MEMBER]            AS tab 
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]          AS sch 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]    AS grantor
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]    AS grantee
...
SELECT
     ...
     , usg.IS_GRANTABLE
  FROM
       DEFINITION_SCHEMA.USAGE_PRIVILEGES@GLOBAL[RANDOM_MEMBER]  AS usg
     , DEFINITION_SCHEMA.SEQUENCES@GLOBAL[RANDOM_MEMBER]         AS sqc
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]          AS sch
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]    AS grantor
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]    AS grantee
...
SELECT
     ...
     , tab.COMMENTS
  FROM 
       DEFINITION_SCHEMA.VIEWS@GLOBAL[RANDOM_MEMBER]            AS viw
     , DEFINITION_SCHEMA.TABLES@GLOBAL[RANDOM_MEMBER]           AS tab 
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]         AS sch 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]   AS auth1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]   AS auth2 
...
SELECT 
     ...
     , tab2.TABLE_NAME
  FROM 
       DEFINITION_SCHEMA.VIEW_TABLE_USAGE@GLOBAL[RANDOM_MEMBER] AS vtu
...
SELECT 
  ...
  FROM 
       DEFINITION_SCHEMA.VIEW_ROUTINE_USAGE@GLOBAL[RANDOM_MEMBER] AS vru
     , DEFINITION_SCHEMA.TABLES@GLOBAL[RANDOM_MEMBER]             AS tab1 
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]           AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]     AS auth1
     , DEFINITION_SCHEMA.ROUTINES@GLOBAL[RANDOM_MEMBER]           AS rtn
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]           AS sch2 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]     AS auth2
 WHERE
       rtn.IS_PRIVATE_ROUTINE = FALSE
   AND vru.TABLE_ID          = tab1.TABLE_ID
...
SELECT
   ...
   FROM 
     ( ( DEFINITION_SCHEMA.ROUTINES@GLOBAL[RANDOM_MEMBER] AS R
     LEFT JOIN
          INFORMATION_SCHEMA.WHOLE_DTDS@GLOBAL[RANDOM_MEMBER] AS D
     ...
     LEFT JOIN
          INFORMATION_SCHEMA.WHOLE_DTDS@GLOBAL[RANDOM_MEMBER] AS DT
...
SELECT
   ...
   FROM 
     ( ( ( ( DEFINITION_SCHEMA.ROUTINES@GLOBAL[RANDOM_MEMBER] AS R
     LEFT JOIN
          DEFINITION_SCHEMA.MODULES@GLOBAL[RANDOM_MEMBER] AS M
       ON ( R.MODULE_SCHEMA_ID = M.MODULE_SCHEMA_ID
            AND
            R.MODULE_ID = M.MODULE_ID ) )
     LEFT JOIN
          DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER] AS m_sch
...
SELECT 
  ...
  FROM
       ( DEFINITION_SCHEMA.PARAMETERS@GLOBAL[RANDOM_MEMBER] AS P
       LEFT JOIN
         INFORMATION_SCHEMA.WHOLE_DTDS@GLOBAL[RANDOM_MEMBER] AS DTD
...
SELECT 
  ...
  FROM
       DEFINITION_SCHEMA.ROUTINE_PRIVILEGES@GLOBAL[RANDOM_MEMBER] AS RP
     , DEFINITION_SCHEMA.ROUTINES@GLOBAL[RANDOM_MEMBER]           AS R
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]           AS sch 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]     AS grantor
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]     AS grantee
 ...
 WHERE
       R.IS_PRIVATE_ROUTINE = FALSE
   AND RP.SPECIFIC_ID = R.SPECIFIC_ID
...
SELECT 
  ...
  FROM 
       DEFINITION_SCHEMA.ROUTINE_ROUTINE_USAGE@GLOBAL[RANDOM_MEMBER] AS rru
     , DEFINITION_SCHEMA.ROUTINES@GLOBAL[RANDOM_MEMBER]         AS rtn1
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]   AS auth1
     , DEFINITION_SCHEMA.ROUTINES@GLOBAL[RANDOM_MEMBER]         AS rtn2
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]         AS sch2 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]   AS auth2
 WHERE
       rtn1.IS_PRIVATE_ROUTINE = FALSE
   AND rtn2.IS_PRIVATE_ROUTINE = FALSE
   AND rru.SPECIFIC_ID        = rtn1.SPECIFIC_ID
...
SELECT 
  ...
  FROM 
       DEFINITION_SCHEMA.ROUTINE_SEQUENCE_USAGE@GLOBAL[RANDOM_MEMBER] AS rsu
     , DEFINITION_SCHEMA.ROUTINES@GLOBAL[RANDOM_MEMBER]         AS rtn1
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]   AS auth1
     , DEFINITION_SCHEMA.SEQUENCES@GLOBAL[RANDOM_MEMBER]        AS seq2
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]         AS sch2 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]   AS auth2
 WHERE
       rtn1.IS_PRIVATE_ROUTINE = FALSE
   AND rsu.SPECIFIC_ID        = rtn1.SPECIFIC_ID
...
SELECT 
  ...
  FROM 
       DEFINITION_SCHEMA.ROUTINE_TABLE_USAGE@GLOBAL[RANDOM_MEMBER] AS rtu
     , DEFINITION_SCHEMA.ROUTINES@GLOBAL[RANDOM_MEMBER]         AS rtn1
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]   AS auth1
     , DEFINITION_SCHEMA.TABLES@GLOBAL[RANDOM_MEMBER]           AS tab2
     , DEFINITION_SCHEMA.SCHEMATA@GLOBAL[RANDOM_MEMBER]         AS sch2 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@GLOBAL[RANDOM_MEMBER]   AS auth2
 WHERE
       rtn1.IS_PRIVATE_ROUTINE = FALSE
   AND rtu.SPECIFIC_ID        = rtn1.SPECIFIC_ID
...
SELECT
     ...
     , sch.SCHEMA_NAME
     , syn.SYNONYM_NAME
     , CAST( 'SYNONYM' AS VARCHAR(32 OCTETS) )
     , NULL
  FROM
...
SELECT
     ...
     , NULL
  FROM
       DEFINITION_SCHEMA.PUBLIC_SYNONYMS@LOCAL  AS psyn
)
;
...
--##############################################################
--# INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS for ODBC SQLColumns()
--##############################################################
...
DROP VIEW IF EXISTS INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS;

--#####################
--# create view
--#####################

CREATE VIEW INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS 
( 
       TABLE_CATALOG 
     , TABLE_SCHEMA 
     , TABLE_NAME 
...
SELECT
     ...
     , COMMENTS 
  FROM 
       INFORMATION_SCHEMA.DBC_COLUMNS
 UNION ALL
SELECT 
       col.TABLE_CATALOG 
     , sch.SCHEMA_NAME
     ...
     , col.COMMENTS 
  FROM 
       INFORMATION_SCHEMA.DBC_COLUMNS          AS col
     , DEFINITION_SCHEMA.SYNONYMS@LOCAL        AS syn
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL        AS sch 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL  AS auth
 WHERE
       syn.SCHEMA_ID    = sch.SCHEMA_ID
   AND syn.OWNER_ID     = auth.AUTH_ID
   AND col.TABLE_SCHEMA = syn.OBJECT_SCHEMA_NAME
   AND col.TABLE_NAME   = syn.OBJECT_NAME
 UNION ALL
SELECT 
       col.TABLE_CATALOG 
     , CAST( NULL AS VARCHAR(128 OCTETS) )
  ...
  FROM 
     ...
     , DEFINITION_SCHEMA.PUBLIC_SYNONYMS@LOCAL  AS psyn
 WHERE
       col.TABLE_SCHEMA = psyn.OBJECT_SCHEMA_NAME
   AND col.TABLE_NAME   = psyn.OBJECT_NAME
;
...
COMMENT ON TABLE INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS 
        IS 'Identify the columns of tables defined in this cataog that are accessible to given user or role.';
...
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.TABLE_CATALOG                    
        IS 'catalog name of the column';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.TABLE_SCHEMA                     
        IS 'schema name of the column'; 
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.TABLE_NAME                       
        IS 'table name of the column'; 
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.COLUMN_NAME                      
        IS 'column name';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.ORDINAL_POSITION                 
        IS 'the ordinal position (> 0) of the column in the table';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.COLUMN_DEFAULT                   
        IS 'the default for the column'; 
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.IS_NULLABLE                      
        IS 'is nullable of the column'; 
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.DATA_TYPE                        
        IS 'the standard name of the data type'; 
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.CHARACTER_MAXIMUM_LENGTH         
        IS 'the maximum length in characters';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.CHARACTER_OCTET_LENGTH           
        IS 'the maximum length in octets';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.NUMERIC_PRECISION                
        IS 'the numeric precision of the numerical data type'; 
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.NUMERIC_PRECISION_RADIX          
        IS 'the radix ( 2 or 10 ) of the precision of the numerical data type';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.NUMERIC_SCALE                    
        IS 'the numeric scale of the exact numerical data type';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.DATETIME_PRECISION               
        IS 'for a datetime or interval type, the value is the fractional seconds precision';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.INTERVAL_PRECISION               
        IS 'for a interval type, the value is the leading precision';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.SCOPE_CATALOG                    
        IS 'catalog name of the referenceable table if DATA_TYPE is REF';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.SCOPE_SCHEMA                     
        IS 'schema name of the referenceable table if DATA_TYPE is REF';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.SCOPE_NAME                       
        IS 'scope name of the referenceable table if DATA_TYPE is REF';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.IS_IDENTITY                      
        IS 'is an identity column';
COMMENT ON COLUMN INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS.COMMENTS                         
        IS 'comments of the column';
...
GRANT SELECT ON TABLE INFORMATION_SCHEMA.DBC_COLUMNS_WITH_SYNONYMS TO PUBLIC;
...
DROP PUBLIC SYNONYM IF EXISTS DBC_COLUMNS_WITH_SYNONYMS;
...
SELECT
  ...
  FROM 
       DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl
         LEFT OUTER JOIN  DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch2
 ...
 WHERE 
   ...
   AND ( mdl.MODULE_ID IN ( SELECT pvmdl.MODULE_ID 
                              FROM DEFINITION_SCHEMA.MODULE_PRIVILEGES@LOCAL AS pvmdl 
                             WHERE ( pvmdl.GRANTEE_ID IN ( SELECT AUTH_ID 
                                                             FROM DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL AS autab 
                                                            WHERE autab.AUTHORIZATION_NAME IN ( 'PUBLIC', CURRENT_USER )  
                                                         ) 
                                   -- OR  
                                   -- pvtab.GRANTEE_ID IN ( SELECT AUTH_ID 
         ...
         mdl.MODULE_SCHEMA_ID IN ( SELECT pvsch.SCHEMA_ID 
                                    ...
                                    WHERE pvsch.PRIVILEGE_TYPE IN ( 'CONTROL SCHEMA', 'ALTER PACKAGE', 'DROP PACKAGE', 'EXECUTE PACKAGE' ) 
                                      AND ( pvsch.GRANTEE_ID IN ( SELECT AUTH_ID 
                                                                    FROM DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL AS ausch 
                                                                   WHERE ausch.AUTHORIZATION_NAME IN ( 'PUBLIC', CURRENT_USER )  
                                                                ) 
                                          -- OR  
                                          -- pvsch.GRANTEE_ID IN ( SELECT AUTH_ID 
         ...
         OR 
         EXISTS ( SELECT GRANTEE_ID  
                    FROM DEFINITION_SCHEMA.DATABASE_PRIVILEGES@LOCAL pvdba 
                   WHERE pvdba.PRIVILEGE_TYPE IN ( 'ALTER ANY PACKAGE', 'DROP ANY PACKAGE', 'EXECUTE ANY PACKAGE' )
                     AND ( pvdba.GRANTEE_ID IN ( SELECT AUTH_ID 
                                                   FROM DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL AS audba 
                                                  WHERE audba.AUTHORIZATION_NAME IN ( 'PUBLIC', CURRENT_USER )  
                                                ) 
                        -- OR  
                        -- pvdba.GRANTEE_ID IN ( SELECT AUTH_ID 
...
SELECT 
  ...
  FROM
       DEFINITION_SCHEMA.MODULE_PRIVILEGES@LOCAL  AS pvmdl
     , DEFINITION_SCHEMA.MODULES@LOCAL            AS mdl
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL           AS sch 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL     AS grantor
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL     AS grantee
...
SELECT 
     ...
     , tab2.TABLE_NAME                                -- TABLE_NAME
  FROM 
       DEFINITION_SCHEMA.MODULE_TABLE_USAGE@LOCAL AS mtu
     , DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl1
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth1
     , DEFINITION_SCHEMA.TABLES@LOCAL           AS tab2
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch2 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth2
 WHERE 
...
SELECT 
  ...
  FROM 
       DEFINITION_SCHEMA.MODULE_MODULE_USAGE@LOCAL AS mmu
     , DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl1
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth1
     , DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl2
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch2 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth2
 WHERE 
...
SELECT 
  ...
  FROM 
       DEFINITION_SCHEMA.MODULE_ROUTINE_USAGE@LOCAL AS mru
     , DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl1
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth1
     , DEFINITION_SCHEMA.ROUTINES@LOCAL         AS rtn2
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch2 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth2
 WHERE
       rtn2.IS_PRIVATE_ROUTINE = FALSE
   AND mru.MODULE_ID         = mdl1.MODULE_ID
...
SELECT 
     ...
     , seq2.SEQUENCE_NAME                             -- SEQUENCE_NAME
  FROM 
       DEFINITION_SCHEMA.MODULE_SEQUENCE_USAGE@LOCAL AS msu
     , DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl1
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth1
     , DEFINITION_SCHEMA.SEQUENCES@LOCAL        AS seq2
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch2 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth2
 WHERE 
...
SELECT
  ...
  FROM 
       DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl
     , DEFINITION_SCHEMA.MODULE_BODY@LOCAL      AS mdlbd
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth 
 WHERE 
       mdl.MODULE_SCHEMA_ID = sch.SCHEMA_ID
...
SELECT 
     ...
     , tab2.TABLE_NAME                                -- TABLE_NAME
  FROM 
       DEFINITION_SCHEMA.MODULE_BODY_TABLE_USAGE@LOCAL AS mbtu
     , DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl1
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth1
     , DEFINITION_SCHEMA.TABLES@LOCAL           AS tab2
...
SELECT 
     ...
     , mdl2.MODULE_NAME                               -- REF_MODULE_NAME
  FROM 
       DEFINITION_SCHEMA.MODULE_BODY_MODULE_USAGE@LOCAL AS mbmu
     , DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl1
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth1
     , DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl2
...
SELECT 
     ...
     , rtn2.SPECIFIC_NAME                             -- ROUTINE_NAME
  FROM 
       DEFINITION_SCHEMA.MODULE_BODY_ROUTINE_USAGE@LOCAL AS mbru
     , DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl1
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth1
     , DEFINITION_SCHEMA.ROUTINES@LOCAL         AS rtn2
 ...
 WHERE
       rtn2.IS_PRIVATE_ROUTINE = FALSE
   AND mbru.MODULE_ID         = mdl1.MODULE_ID
...
SELECT 
     ...
     , seq2.SEQUENCE_NAME                             -- SEQUENCE_NAME
  FROM 
       DEFINITION_SCHEMA.MODULE_BODY_SEQUENCE_USAGE@LOCAL AS mbsu
     , DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl1
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth1
     , DEFINITION_SCHEMA.SEQUENCES@LOCAL        AS seq2
...
SELECT 
  ...
  FROM 
       DEFINITION_SCHEMA.VIEW_MODULE_USAGE@LOCAL AS vmu
     , DEFINITION_SCHEMA.TABLES@LOCAL           AS tab1
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth1
     , DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl2
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch2 
...
SELECT 
     ...
     , mdl2.MODULE_NAME                               -- MODULE_NAME
  FROM 
       DEFINITION_SCHEMA.ROUTINE_MODULE_USAGE@LOCAL AS rmu
     , DEFINITION_SCHEMA.ROUTINES@LOCAL         AS rtn1
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch1 
     , DEFINITION_SCHEMA.AUTHORIZATIONS@LOCAL   AS auth1
     , DEFINITION_SCHEMA.MODULES@LOCAL          AS mdl2
     , DEFINITION_SCHEMA.SCHEMATA@LOCAL         AS sch2 
 ...
 WHERE
       rtn1.IS_PRIVATE_ROUTINE = FALSE
   AND rmu.SPECIFIC_ID        = rtn1.SPECIFIC_ID
