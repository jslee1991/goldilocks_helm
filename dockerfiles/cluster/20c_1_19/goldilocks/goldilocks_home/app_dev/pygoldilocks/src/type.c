                                ...
                                SQLLEN   aDataLen )
{
    ...
    {
        sPtr = (char*)PyUnicode_AsUTF8AndSize( sEncodedData, &sPyLen );
    }
    else
    {
    ...
    switch( aCType )
    {
        case SQL_C_CHAR:
            if( (aSQLType == SQL_DECIMAL) || (aSQLType == SQL_NUMERIC) )
            {
                ...
                {
                    sPtr = (char*)PyUnicode_AsUTF8AndSize( sEncoded, &sEncodedLen );
                }
                else
                {
